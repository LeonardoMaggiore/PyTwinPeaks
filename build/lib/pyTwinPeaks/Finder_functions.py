...
def calculate_covariance_matrix(profiles, plot=False):
    ...
    if plot == True:
        ...
        plt.tight_layout()
        plt.savefig("/home/leonardo/Desktop/Maggiore_2025/pdfs2/cov_mat_all_LCDM.pdf", format='pdf', bbox_inches='tight')
        plt.show()
    ...
    for i in range(len(cosmoin)):
        ...
        if rp is None and i == 0:
            for d in dirs[:3]:  # try in dirs[0], dirs[1], dirs[2]
                path_rp = os.path.join(pre_path, 'output_relative', cosmoin[i], subfolderss[0], d)
...
def plot_every_bin(pre_path, cosmoin, dirs, fradius, line_style, color_dir):
    ...
    plt.savefig("/home/leonardo/Desktop/Maggiore_2025/pdfs2/all_bins_cosmo.pdf", format='pdf', bbox_inches='tight')
...
def cornerplot_cosmologies(cosmoin, cobaya_path, n_cores, color, binsize=0, sigmas=None):
    ...
    if binsize==0:
        plt.savefig('/home/leonardo/Desktop/Maggiore_2025/pdfs2/contours.pdf', format='pdf', bbox_inches='tight')
        #plt.savefig(f'contours_cosmologies_binsize_{binsize}.pdf', format='pdf')
    elif binsize==1:
        plt.savefig('/home/leonardo/Desktop/Maggiore_2025/pdfs2/piccoli.pdf', format='pdf', bbox_inches='tight')
    elif binsize==2:   
        plt.savefig('/home/leonardo/Desktop/Maggiore_2025/pdfs2/medi.pdf', format='pdf', bbox_inches='tight')
    elif binsize==3:
        plt.savefig('/home/leonardo/Desktop/Maggiore_2025/pdfs2/grandi.pdf', format='pdf', bbox_inches='tight')
...
def cornerplot_bins(cosmoc, cobaya_path, dirs, n_cores, color_dir, sigmas=None):
    ...
    plt.savefig('/home/leonardo/Desktop/Maggiore_2025/pdfs2/total_contours_3bins.pdf', format='pdf', bbox_inches='tight')
